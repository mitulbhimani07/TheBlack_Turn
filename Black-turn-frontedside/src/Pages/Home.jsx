...
function Home() {
  ...
  {clients.map((client) => (
    ...
    `}</style>
      ...
      <div className="bg-white flex flex-col lg:flex-row items-center justify-between mx-auto px-6 md:px-8 py-12 md:py-16 lg:max-w-7xl ">
        {/* Left side - Text and buttons */}
        <div className="flex-1 max-w-md text-center lg:text-left mb-12 lg:mb-0">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Download the app
          </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
            <a href='https://play.google.com/store/apps/details?id=com.theblackturn.app' target='_blank' className="flex items-center gap-3 bg-[#005F73] text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">
            ...
            <a href='https://apps.apple.com/us/app/the-black-turn/id6702028842' target='_blank' className="flex items-center gap-3 bg-gray-900 text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors">
              <div className="w-6 h-6">
                <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="flex-1 flex justify-center relative w-full">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 sm:w-80 md:w-96 h-72 sm:h-80 md:h-96 rounded-full bg-[#005F73] opacity-90"></div>
          <div className="relative z-10 w-60 sm:w-64 md:w-72 h-[500px] sm:h-[540px] md:h-[580px] rounded-[3rem] p-2">
