      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-6xl w-full overflow-hidden flex">
        ...
        <div className="w-1/2 p-12 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            ...
            <p className="text-gray-600 mb-8">Create your account to start exploring with us</p>
            ...
            <div className="mt-8 mb-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-gray-500">Sign up with Others</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <Link to='/Signin' className='text-blue-500'>SignUp</Link>
            </div>
