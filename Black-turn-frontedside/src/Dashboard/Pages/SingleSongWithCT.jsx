          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-[#005f73]">
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-4 md:grid-cols-8 gap-4 mb-6">
                ...
                <div className="bg-white p-2 rounded border shadow-sm">
                  <div className="h-8 bg-purple-600 rounded flex items-center justify-center">
                    <span className="text-white text-xs font-bold">RuPay</span>
                  </div>
                </div>
                <div className="bg-white p-2 rounded border shadow-sm">
                  <div className="h-8 bg-gray-800 rounded flex items-center justify-center">
                ...
                <div className="bg-white p-2 rounded border shadow-sm">
                  <div className="h-8 bg-green-600 rounded flex items-center justify-center">
                    <span className="text-white text-xs font-bold">GPay</span>
                  </div>
                </div>
                <div className="bg-white p-2 rounded border shadow-sm">
                  <div className="h-8 bg-purple-700 rounded flex items-center justify-center">
            ...
            <button
              ...
              className={`w-full py-4 rounded-lg font-bold text-lg transition-all transform hover:scale-[1.02] ${
                formData.originalWork && formData.agreeTerms
