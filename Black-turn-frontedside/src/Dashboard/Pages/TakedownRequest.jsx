                ...
                <main className="p-6 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 relative">
                        <div className="flex justify-between items-start mb-4">
                            <h2 className="text-lg font-semibold text-[#004d66]">No Songs Published <span className="text-sm text-gray-500">by You</span></h2>
                        ...
                        <p className="mt-3 text-sm text-gray-600">
                            Incase, you have uploaded the song. Click <span className="text-blue-600 underline cursor-pointer"><a href="/#/all-releases">Check Song Status</a></span>. If the Song Status is Completed. Then please <span className="text-blue-600 underline cursor-pointer">Raise a Complain</span>.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-lg font-semibold text-[#004d66]">Recent Song Takedown Requests <span className="text-sm text-gray-500">| Submitted by you</span></h2>
                            <input
                                type="text"
                                placeholder="Search..."
