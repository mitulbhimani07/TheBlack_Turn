...
const downloadYearwise = async () => {
  ...
  <p className="text-sm sm:text-base text-gray-600">
    Select platforms, time period, and download your reports
  </p>
</div>
...
<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8 mx-4 sm:mx-0">
  ...
  <div className="space-y-3 text-sm sm:text-base">
    <div className="flex items-start sm:items-center text-gray-700 gap-3">
      <span className="w-6 h-6 bg-[#005f73] text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-medium">
        1
      </span>
...
<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8 mx-4 sm:mx-0">
  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4 sm:mb-6">
    ...
    {/* Add a button or search filter if needed here */}
  </div>
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-9 gap-4">
    {platforms.map((platform) => (
      <div
        key={platform.id}
        className="relative p-2 sm:p-3 rounded-lg cursor-pointer hover:bg-gray-50 transition"
        onClick={() => handlePlatformToggle(platform.id)}
      >
        <div className="flex flex-col items-center justify-center">
          <div className="group w-14 h-14 sm:w-20 sm:h-20 flex items-center justify-center rounded-xl bg-white shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
            <img
              src={platform.icon}
              alt={platform.name}
          ...
          {/* <p className="mt-2 text-sm text-gray-700 font-medium text-center truncate w-full">
            {platform.name}
          </p> */}
        </div>
      </div>
...
<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8 mx-4 sm:mx-0">
  ...
  {showFilters && (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
      ...
      {/* Data Table */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-8 mx-4 sm:mx-0">
  {/* Header */}
  <div className="px-4 sm:px-6 py-4 border-b border-gray-200">
    <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Report Data</h2>
  </div>
  ...
  <div className="w-full overflow-x-auto">
    <table className="min-w-full">
      <thead className="bg-[#005f73] text-white">
        <tr>
          <th className="px-4 sm:px-6 py-3 text-left text-sm font-medium">Platform</th>
          <th className="px-4 sm:px-6 py-3 text-left text-sm font-medium">Month</th>
          <th className="px-4 sm:px-6 py-3 text-left text-sm font-medium">Year</th>
          <th className="px-4 sm:px-6 py-3 text-left text-sm font-medium">Downloads</th>
        </tr>
      </thead>
        ...
        {loading ? (
          ...
          filteredData.map((row) => (
            <tr key={row.id} className="hover:bg-gray-50">
              <td className="px-4 sm:px-6 py-4 text-sm font-medium text-gray-900">{row.platform}</td>
              <td className="px-4 sm:px-6 py-4 text-sm text-gray-700">{row.month}</td>
              <td className="px-4 sm:px-6 py-4 text-sm text-gray-700">{row.year}</td>
              <td className="px-4 sm:px-6 py-4 text-sm text-gray-700">{row.downloads.toLocaleString()}</td>
            </tr>
          ))
        )}
      </tbody>
